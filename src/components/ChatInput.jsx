  ...
  return (
    ...
    >
      <input
        ...
        className="flex-1 w-full px-4 md:px-5 py-2 md:py-3 rounded-full border-2 border-slate-300 bg-white text-sm md:text-base text-slate-900 placeholder-slate-400 focus:outline-hidden focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 shadow-xs"
      />
      <button
        type="submit"
        disabled={!query.trim()}
